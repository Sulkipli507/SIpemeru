...
@section('content')
    <form action="{{ route('loan-update', $loan->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
          <label for="program" class="form-label">Scan Surat </label> <br>
          <a class="btn btn-info" href="{{ asset('storage/'.$loan->letter) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
          ...
          <small class="text-muted">Kosongkan jika tidak ingin mengubah surat</small>
          <hr class="my-3">
        </div>
