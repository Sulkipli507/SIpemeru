...
<form action="{{route("room-update", $rooms->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div>
      ...
      <a class="btn btn-info" href="{{ asset('storage/'.$rooms->format) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
