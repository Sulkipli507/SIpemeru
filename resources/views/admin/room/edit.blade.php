...
<form action="{{route("room-update", $rooms->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div>
      ...
      <img class="mb-2" src="{{asset('storage/'.$rooms->image)}}" width="120px" /><br>
    ...
    <div>
      <label for="format">Format surat</label><br>
      <a class="btn btn-info mb-2" href="{{ asset('storage/'.$rooms->format) }}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
      ...
      <small class="text-muted">Kosongkan jika tidak ingin mengubah format surat</small>
      <hr class="my-3">
    </div>
