	<link rel="apple-touch-icon" sizes="180x180" href="{{asset('backend/vendors/images/sp-ikon.png')}}">
	<link rel="icon" type="image/png" sizes="32x32" href="{{asset('backend/vendors/images/sp-ikon.png')}}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{asset('backend/vendors/images/sp-ikon.png')}}">
	...
	<link rel="stylesheet" type="text/css" href="{{asset('backend/src/plugins/jvectormap/jquery-jvectormap-2.0.3.css')}}">
